      ...
      <div className={styles.detailContent}>
        <div className={styles.detailMain}>
          ...
          <div className={styles.placeholderSection}>
            ...
            <div className={styles.placeholderDesc}>
              {locale === 'vi' ? 'Hình ảnh sẽ được tải từ API' : 'Photos will be loaded from API'}
            </div>
        ...
        <div className={styles.detailSidebar}>
          <div className={styles.sidebarCard}>
            ...
            <div className={styles.sidebarItem}>📍 {locale === 'vi' ? 'Phố đi bộ Nguyễn Huệ' : 'Nguyen Hue Walking Street'}</div>
            <div className={styles.sidebarItem}>🕐 18:00 - 22:00</div>
            <div className={styles.sidebarItem}>💰 {locale === 'vi' ? 'Miễn phí' : 'Free admission'}</div>
          </div>
