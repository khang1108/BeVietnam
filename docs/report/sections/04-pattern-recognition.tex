...
Đối với BeVietnam, ta nhận ra có ba mẫu lặp rất rõ, và mỗi mẫu lặp này
đều dẫn tới một quyết định thiết kế cụ thể.
...
\textbf{Kế đến} là mẫu \textbf{retrieve → explain → present}. Trong
khám phá địa điểm, hệ thống truy xuất dữ liệu về điểm đến, sau đó giải
