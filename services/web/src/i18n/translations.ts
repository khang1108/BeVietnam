...
const vi: Translations = {
  ...
  storyline: {
    ...
    locked: 'Chưa khám phá',
    explore: 'Khám phá',
    aiGenerating: 'AI đang tạo...',
    culturalKnowledge: 'Kiến thức văn hóa',
    completionRequirement: 'Điều kiện hoàn thành',
    completeBtn: 'Hoàn thành',
    step: 'Chặng',
    checkinTitle: 'Check-in tại đây',
    checkinDesc: 'Mở camera, chụp ảnh kỷ niệm và lưu lại khoảnh khắc của bạn tại địa điểm này.',
    openCamera: 'Mở Camera Check-in',
    retake: 'Chụp lại',
    saveAndComplete: 'Lưu khoảnh khắc & Hoàn thành',
    takePhotoFirst: 'Chụp ảnh để hoàn thành',
    saving: 'Đang lưu...',
    myMoments: 'Khoảnh khắc của tôi',
    cameraError: 'Không thể truy cập camera. Vui lòng cấp quyền camera.',
    difficulty: {
      easy: 'Dễ',
      medium: 'Trung bình',
      hard: 'Khó',
...
const en: Translations = {
  ...
  storyline: {
    tag: 'Journey Chronicle',
    title: 'Heritage of',
    titleHighlight: 'Vietnam',
    subtitle: 'Discover the heritage, culture, and hidden beauty of the S-shaped land. Every stop is a priceless story.',
    progress: 'Journey',
    explored: 'explored',
    completed: 'Completed',
    loading: 'Loading journey...',
    locked: 'Not yet explored',
    explore: 'Explore',
    ...
    step: 'Step',
    checkinTitle: 'Check-in Here',
    checkinDesc: 'Open the camera, take a memorable photo and save your moment at this location.',
    openCamera: 'Open Camera Check-in',
    retake: 'Retake',
    saveAndComplete: 'Save Moment & Complete',
    takePhotoFirst: 'Take a photo to complete',
    saving: 'Saving...',
