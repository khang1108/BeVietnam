                    ...
                    <form onSubmit={(e) => e.preventDefault()}>
                        <div className={styles.formGroup}>
                            ...
                            <input
                                ...
                                placeholder={
                                    locale === 'vi' ? 'Nhập tên địa điểm...' : 'Enter place name...'
                                }
                            />
                        </div>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            >
                                ...
                                <option value="culture">
                                    {locale === 'vi' ? 'Văn hóa' : 'Culture'}
                                </option>
                                <option value="nature">
                                    {locale === 'vi' ? 'Thiên nhiên' : 'Nature'}
                                </option>
                                <option value="history">
                                    {locale === 'vi' ? 'Lịch sử' : 'History'}
                                </option>
                                <option value="nightlife">
                                    {locale === 'vi' ? 'Về đêm' : 'Nightlife'}
                                </option>
                            </select>
                        </div>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <input
                                ...
                                className={styles.formInput}
                                placeholder={
                                    locale === 'vi' ? 'Nhập địa chỉ...' : 'Enter address...'
                                }
                            />
                        </div>
                ...
                <div className={styles.detailSidebar}>
                    <div className={styles.sidebarCard}>
                        ...
                        <div className={styles.sidebarItem}>
                            ...
                            {locale === 'vi'
                                ? 'Hình ảnh rõ ràng, chất lượng tốt'
                        ...
                        <div className={styles.sidebarItem}>
                            ...
                            {locale === 'vi'
                                ? 'Mô tả bằng tiếng Việt hoặc Anh'
                                : 'Description in Vietnamese or English'}
                        </div>
                        <div className={styles.sidebarItem}>
                            <span className={styles.sidebarIcon} aria-hidden="true">
                                <IconLink />
                        ...
                        <div className={styles.sidebarItem}>
                            ...
                            {locale === 'vi'
                                ? 'AI sẽ bổ sung bối cảnh văn hóa'
                                : 'AI will add cultural context'}
                        </div>
                    </div>
